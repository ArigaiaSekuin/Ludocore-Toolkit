...
namespace Ludocore
{
    ...
    public class Follow : MonoBehaviour
    {
        ...
        [SerializeField] private bool followOnEnable = true;
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            Gizmos.color = _isFollowing ? Color.green : Color.cyan;
